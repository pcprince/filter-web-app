...
function writeFile (header, samples, callback) {
...
function exportAudio (samples, unthresholdedSamples, start, length, sampleRate, mode, playbackBufferLength, header, callback) {
    ...
    writeFile(headerBuffer, sampleArray, callback);
